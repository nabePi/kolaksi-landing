        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-2 md:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-12 mb-8 sm:mb-12">
            <div className="space-y-4 col-span-2 sm:col-span-2 lg:col-span-1">
              ...
              <div className="inline-flex items-center gap-2.5 px-3 py-2 rounded-lg bg-white border border-slate-200 shadow-sm">
                ...
                <div>
                  ...
                  <div className="text-xs font-semibold text-slate-800">Meta Tech Provider</div>
                </div>
              </div>
            </div>
            <div>
